...
const BotCard = ({ title, description1, description2, description3, description4, image }) => {
  ...
  <motion.a
    href="https://mr-pa.vercel.app/"
    target="_blank"
    rel="noopener noreferrer"
    className="inline-flex items-center px-8 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-full text-white font-semibold text-lg hover:brightness-110 transition-all shadow-lg shadow-purple-600/30 hover:shadow-purple-600/50 hover:scale-105"
    style={{ fontFamily: '"Orbitron", sans-serif' }}
    whileHover={{ scale: 1.05 }}
    whileTap={{ scale: 0.95 }}
